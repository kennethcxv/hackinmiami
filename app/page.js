      ...
      <main className="container mx-auto py-12 px-4">
        ...
        <form onSubmit={handleSubmit} className="mb-8">
          ...
          <div className="relative mb-4">
            ...
            />
            <div className="absolute inset-y-0 left-80 flex items-center pr-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8">
          {Object.entries(data).map(([category, values], index) => (
            <div key={category} className="bg-transparent rounded-lg shadow-lg p-6 border-2 border-blue-500">
              <h2 className="text-2xl font-bold mb-2 text-white">Disease {index + 1}</h2>
              <h3 className="text-xl font-bold mb-4 text-blue-200">{category}</h3>
